...
def usage():
    ...
    print(f'\n\n{script} version {version}\n\n'
        ...
        #   f'\n\t  OR'
          ...
          f'\n\tpython3 {script} net=TA sta=O18A loc=DASH start=2008-08-14T12:00:00 end=2008-08-14T13:30:00'
          f'\n\n\t- limit channel to BHZ, process only one hour (default) and plot the PSD:'
          f'\n\tpython3 {script} net=TA sta=O18A loc=DASH chan=BHZ start=2008-08-14T12:00:00 '
          ...
          f'\n\tpython3 {script} param=computePSD net=TA sta=O18A loc=DASH chan=BHZ start=2008-08-14T12:00:00 '
          ...
          f' \n\tpython3 ntk_computePSD.py param=computePSD net=NM sta=SLM  loc=DASH chan=BHZ '
          f'start=2009-03-01T00:00:00 end=2009-03-31T00:00:00 xtype=period plot=0 verbose=0'
          f'\n\n\t- try other stations and time intervals:'
          f'\n\tpython3 {script} net=NM sta=SLM loc=DASH chan=BHZ start=2009-11-01T12:00:00 '
          f'end=2009-11-01T14:00:00 xtype=period plot=1'
          f'\n\tpython3 {script} param=computePSD net=TA sta=959A loc=DASH start=2013-10-01T11:00:00 '
          f'end=2013-10-01T13:00:00 xtype=period plot=1'
          f'\n\n\t- BHZ channel for GR.BFO with data from a data center other than IRIS:'
          f'\n\tpython3 {script} param=computePSD net=GR sta=BFO loc=DASH chan=BHZ start=2020-10-01T00:00:00 '
          ...
          f'\n\tpython3 {script}  net=TA sta=W5 loc=DASH start=2014-03-17T04:30:00 end=2014-03-17T05:30:00 type=period '
...
#    print("At get_fedcatalog_station in ntk_computePSD")
...
cat={'NCEDC_0': 
      ...
      'dataselect_service': 'https://service.ncedc.org/fdsnws/dataselect/1/', 
      'bulk': [('BK', request_station, request_location, request_channel, request_start_date_time, request_end_date_time)]
      }
    }

for _key in cat:
    print("_key is: ", _key)
    print("Think this is about to get the data")
    #Set the client up for this data center.
    try:
        client = Client(ts_lib.get_service_url(cat, _key))
        print("\n" + "="*50)
        print("CONFIRMATION OF DATA SOURCE:")
        print(f"The script is currently using the following FDSN web service:")
